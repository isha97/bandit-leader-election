...
osascript -e 'tell application "Terminal" to do script "cd /Users/rochan/Documents/UTMasters/UTSpring22/DistributedSystems/leader-election-bft/ && /Users/rochan/Documents/UTMasters/UTSpring22/reinforcement_learning/work/bin/python3 run_simulation_v2.py -c configs/sync_connected.yaml -t node_3"' & 
osascript -e 'tell application "Terminal" to do script "cd /Users/rochan/Documents/UTMasters/UTSpring22/DistributedSystems/leader-election-bft/ && /Users/rochan/Documents/UTMasters/UTSpring22/reinforcement_learning/work/bin/python3 run_simulation_v2.py -c configs/sync_connected.yaml -t node_4"' & 
sleep 5
